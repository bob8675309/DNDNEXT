...
Status: **authoritative art-direction contract, restored to `main` during the 2026-09-21 documentation reconciliation.** The standard originated on PR #187 and remains consistent with the completed 149/149 runtime-visible deck.

This document defines the required visual, dimensional, compositional, and QA standard for every subclass Tarot card used by the Character Forge subclass carousel. The normalized rebuild is now complete for the current runtime-visible catalogue: 149/149 visible choices have dedicated approved cards. Apply this standard to future additions or explicitly requested replacements.
