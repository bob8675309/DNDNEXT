-- Forward repair for databases that already applied the original Tough progression hook.
-- character_option_grant_instances stores acquisition_level (not acquired_level).
