...
assert(selector.includes('"--orbit-back-yaw": `${(-yaw * 0.55).toFixed(2)}deg`'), "Rear Tarot backs must retain partial yaw so the background reads as a circular deck instead of flat panels.");
