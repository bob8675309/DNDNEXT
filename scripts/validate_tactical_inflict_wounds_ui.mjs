...
const required = [
  '"inflict-wounds|xphb"',
  'selectedSpellKey === "cure-wounds|xphb" || selectedSpellKey === "inflict-wounds|xphb" ? 5',
  ...
  'TACTICAL ENCOUNTER • PHASE 1N',
  'Fire Bolt, Cure Wounds, Sacred Flame, Toll the Dead, Poison Spray, False Life, and Inflict Wounds are the current reviewed tactical adapters.',
...
if (!/inflict-wounds\|xphb[\s\S]{0,520}encounter_cast_spell_v6|encounter_cast_spell_v6[\s\S]{0,520}inflict-wounds\|xphb/.test(combat)) {
