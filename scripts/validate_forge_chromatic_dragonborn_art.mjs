...
assert.ok(speciesPortraitArtworkFor("Brass Dragonborn").endsWith("dragonborn-metallic.webp?portrait=brass-dragonborn"), "unfinished Metallic Dragonborn must remain explicit temporary Forge portrait treatment");
...
console.log("Chromatic Dragonborn Forge artwork validated: Black, Blue, Green, Red, and White use real dedicated WebP assets in the Forge, canonical shared artwork stays stable outside the Forge, unfinished Metallic/Gem variants remain explicit temporary treatments, and protected map/travel boundaries remain untouched.");
