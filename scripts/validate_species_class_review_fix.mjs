...
for (const token of ["artificerHero", "barbarianHero", "artificerMenu", "barbarianMenu", "CINEMATIC_CLASS_HERO_ARTWORK", "CINEMATIC_CLASS_MENU_ARTWORK"]) {
  assert(classArtwork.includes(token), `Class cinematic artwork authority is missing ${token}`);
}
...
console.log("Species/Class cinematic reference pass validated: full-height layered Species hero, generated Class idle artwork, blended selected-Class paintings, purpose-specific class menu portraits, visible subclasses, preserved progression and protected boundaries.");
