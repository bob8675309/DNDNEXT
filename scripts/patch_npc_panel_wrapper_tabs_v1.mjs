...
const before = `            <div className="btn-group btn-group-sm" role="tablist" aria-label="NPC profile views">
...
const after = `            {typeof renderInteractionTabs === "function" && !hasCraftCapability ? renderInteractionTabs() : (
