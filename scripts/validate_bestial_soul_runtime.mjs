...
for (const token of ["update public.character_progression","update public.inventory_items","insert into public.inventory_items","delete from public.inventory_items","swimSpeed","climbSpeed","walking_speed"]) forbid(migration,token);
console.log("Bestial Soul PHB/TCE source gating, source-derived adaptations, post-acquisition Short/Long-Rest selection, next-rest expiry semantics, encounter lock, ACLs, text-derived Forge suppression, host wiring, and protected boundaries validated.");
