...
const steps = [
  ...
  ["node", ["scripts/validate_tactical_spell_casting.mjs"]],
  ["node", ["scripts/validate_tactical_spell_ui.mjs"]],
  ["node", ["scripts/validate_tactical_save_spell.mjs"]],
  ["node", ["scripts/validate_tactical_save_spell_ui.mjs"]],
  ["node", ["scripts/validate_tactical_toll_the_dead.mjs"]],
  ["node", ["scripts/validate_tactical_toll_the_dead_ui.mjs"]],
  ["node", ["scripts/validate_tactical_poison_spray.mjs"]],
  ["node", ["scripts/validate_tactical_poison_spray_ui.mjs"]],
  ["node", ["scripts/validate_tactical_false_life.mjs"]],
  ["node", ["scripts/validate_tactical_false_life_ui.mjs"]],
  ["node", ["scripts/validate_tactical_inflict_wounds.mjs"]],
  ["node", ["scripts/validate_tactical_inflict_wounds_ui.mjs"]],
  ["npx", ["next", "build"]],
];
