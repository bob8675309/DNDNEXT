...
]) assert(framing.includes(token), `Higher stable top-right Class cinematic contract is missing ${token}`);
...
console.log("Class hero framing validation passed: legacy paintings retain safe framing, public cinematic art is fixed higher in a stable top-right layer independent of subclass/content height, artwork roles remain separate, and protected boundaries are untouched.");
