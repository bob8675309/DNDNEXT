...
includes(trainingStep, ["Background Grants", "Skills Selected", "Class Skills", "Training Choices", "Crafting Professions", "Feat &amp; Class Choices", "Training Picks", "each uses one Training choice", "Most recipes are attempted during a Short or Long Rest", "NpcForgeTrainingStepBase", "NpcForgeSourceChoiceFields", 'placement="training" inline'], "training step");
