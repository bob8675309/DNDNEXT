...
includes(trainingStep, ["Background Grants", "Class Skills", "Training Choices", "Crafting Professions", "Feat &amp; Class Choices", "each uses one Training choice", "Most recipes are attempted during a Short or Long Rest", "NpcForgeTrainingStepBase", "NpcForgeSourceChoiceFields"], "training step");
