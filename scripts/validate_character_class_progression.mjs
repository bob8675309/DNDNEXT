...
for (const token of ["feats.json", "backgrounds.json", "races.json", "fluff-races.json", "firstLoreParagraph", "loreSource", "skills.json", "option_key", "Preview/batch generation only"]) {
