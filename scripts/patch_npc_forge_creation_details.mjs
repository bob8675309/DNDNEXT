...
if (!modalSource.includes('<span>Languages</span><input value={draft.languagesText}')) modalSource = modalSource.replace(backgroundHeading, originDetailFields + backgroundHeading);
...
requireMarkers(modalSource, ["ALIGNMENT_OPTIONS", "SIZE_OPTIONS", "languagesText", "<span>Languages</span>", "Appearance", "Treasure / coin"], "NewNpcModal.js");
