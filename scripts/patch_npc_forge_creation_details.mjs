...
characterSource = patchOnce(characterSource, '      rank: professionData[key].rank,\n      ability: professionData[key].ability,\n    }])),\n', '      rank: professionData[key].rank,\n      ability: professionData[key].ability,\n      offersService: Boolean(professionData[key].offersService),\n    }])),\n', "profession service sheet flags");
...
requireMarkers(characterSource, ["ALIGNMENT_OPTIONS", "SIZE_OPTIONS", "normalizeLanguages", "appearance: cleanText", "treasure: cleanText", "offersService: Boolean(professionData[key].offersService)"], "characterCreation.js");
