...
// DNDNext alchemy-only DB seed.
//
// Purpose:
// - Mirrors public/items/alchemy-catalog.json into public.items_catalog.
...
//
// Merge note:
// Keep payload.alchemy stable. The Items page, merchant stock, loot tables,
