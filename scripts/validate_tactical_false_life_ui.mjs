...
if (!/poison-spray\|xphb[\s\S]{0,1040}encounter_cast_spell_v4|encounter_cast_spell_v4[\s\S]{0,1040}poison-spray\|xphb/.test(combat)) {
  throw new Error("Tactical False Life UI validation failed: Poison Spray must remain on encounter_cast_spell_v4.");
}
if (!/toll-the-dead\|xphb[\s\S]{0,1140}encounter_cast_spell_v3|encounter_cast_spell_v3[\s\S]{0,1140}toll-the-dead\|xphb/.test(combat)) {
  throw new Error("Tactical False Life UI validation failed: Toll the Dead must remain on encounter_cast_spell_v3.");
}
if (!/sacred-flame\|xphb[\s\S]{0,1240}encounter_cast_spell_v2|encounter_cast_spell_v2[\s\S]{0,1240}sacred-flame\|xphb/.test(combat)) {
