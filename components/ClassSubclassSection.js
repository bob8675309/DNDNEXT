    ...
    return (
      <section className={`npc-forge-class-guide__subclasses is-compact class-subclass-section is-collapsed${detailed ? " is-detailed" : ""}`}>
        ...
        <style jsx global>{`
          ...
          .class-subclass-section.is-collapsed:not(.is-detailed){width:min(35%,430px);max-width:430px}
          ...
          .class-subclass-selected-row__summary{display:grid;grid-template-columns:64px minmax(0,1fr);gap:8px;align-items:center;min-width:0;padding:0;border:0;color:inherit;background:transparent;text-align:left}
          .class-subclass-selected-row__summary:focus-visible{outline:1px solid rgba(var(--class-secondary),.7);outline-offset:2px}
          .class-subclass-selected-row__art{display:block;width:64px;height:32px;overflow:hidden;border:1px solid rgba(var(--class-accent),.42);border-radius:6px;background:#090d15}.class-subclass-selected-row__art img{display:block;width:100%;height:100%;object-fit:cover;object-position:center}
                    .class-subclass-selected-row__copy{display:grid;min-width:0}.class-subclass-selected-row__copy strong{overflow:hidden;color:#f4ebfa;font-family:Georgia,"Times New Roman",serif;font-size:.68rem;font-weight:650;line-height:1.18;text-overflow:ellipsis;white-space:nowrap}
  ...
  return (
    <section className={`npc-forge-class-guide__subclasses is-compact class-subclass-section is-two-column${detailed ? " is-detailed" : ""}${required && !selected ? " is-required" : ""}`}>
          ...
          {orderedOptions.map((option) => {
            ...
            return (
              ...
              >
                ...
                <strong className="class-subclass-two-column__name">{text(option.name) || "Subclass"}</strong>
              </button>
            );
          })}
        </div>
      ...
      <style jsx global>{`
        ...
        @media(max-width:1100px){.class-subclass-section.is-two-column:not(.is-detailed){width:min(42%,430px)}}
