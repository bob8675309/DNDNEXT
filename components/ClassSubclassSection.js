    ...
    return (
      <section className={`npc-forge-class-guide__subclasses is-compact class-subclass-section is-collapsed${detailed ? " is-detailed" : ""}`}>
        ...
        <style jsx global>{`
          ...
          .class-subclass-section.is-collapsed:not(.is-detailed){width:min(54%,620px);max-width:620px}
          ...
          .class-subclass-selected-row__summary{display:grid;grid-template-columns:70px minmax(0,1fr) 20px;gap:8px;align-items:center;min-width:0;padding:0;border:0;color:inherit;background:transparent;text-align:left}
          .class-subclass-selected-row__summary:focus-visible{outline:1px solid rgba(var(--class-secondary),.7);outline-offset:2px}
          .class-subclass-selected-row__art{display:block;width:70px;height:36px;overflow:hidden;border:1px solid rgba(var(--class-accent),.42);border-radius:6px;background:#090d15}.class-subclass-selected-row__art img{display:block;width:100%;height:100%;object-fit:cover;object-position:center}
  ...
  return (
    <section className={`npc-forge-class-guide__subclasses is-compact class-subclass-section is-two-column${detailed ? " is-detailed" : ""}${required && !selected ? " is-required" : ""}`}>
      ...
      <style jsx global>{`
        ...
        .class-subclass-section.is-two-column:not(.is-detailed){width:min(54%,620px);max-width:620px;align-self:start}
        ...
        @media(max-width:1100px){.class-subclass-section.is-two-column:not(.is-detailed){width:min(60%,620px)}}
        ...
        @media(max-width:760px){.class-subclass-two-column__grid{grid-template-columns:1fr}.class-subclass-two-column__scroll{max-height:min(36vh,285px)}.class-subclass-two-column__card{grid-template-columns:74px minmax(0,1fr) auto 20px}}
      `}</style>
    </section>
  );
}
