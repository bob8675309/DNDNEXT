...
function PlayerTrainingStep({
  ...
  return <div className="npc-forge-section npc-forge-training-step npc-forge-training-player-layout">
    <div className="npc-forge-training-summary" aria-label="Training progress">
      ...
      <SummaryCard icon="summary-training.svg" label="Training Choices" value={`${usedTrainingChoices}/${totalTrainingChoices}`} note="Class training picks" state={remainingTrainingChoices === 0 ? "complete" : ""} />
      <SummaryCard icon="summary-feat.svg" label="Feat Choices" value={featChoiceTarget ? `${featChoiceDone}/${featChoiceTarget}` : "—"} note={featChoiceTarget ? "Class feat picks" : "No required pick"} state={(incompleteClassAbility || incompleteSourceClassAbility) ? "required" : "complete"} />
    </div>

    <div className="npc-forge-training-picks">
      <header className="npc-forge-training-picks-head"><h3>Training Picks</h3><p>Choose your training options below.</p></header>
      ...
      <section className="npc-forge-training-pick-group npc-forge-training-crafting">
        ...
        <p className="npc-forge-training-group-copy">Use training picks to gain proficiency with a campaign crafting profession.</p>
        ...
        <p className="npc-forge-training-crafting-note">Campaign crafting house rule: a trained crafting profession uses one Training choice. Most recipes are attempted during a Short or Long Rest after a successful DC check; some require a physical work site such as a forge, enchanting station, ley line, laboratory, or properly deployed caravan workshop.</p>
      </section>

      <details className={`npc-forge-training-choice-section npc-forge-training-feat-section ${(incompleteClassAbility || incompleteSourceClassAbility) ? "is-required" : ""}`}>
    ...
    <div className="npc-forge-training-help"><span>ⓘ</span><div><strong>Need help?</strong><p>Hover any option to learn more in Current Selection. You can revise choices until you continue.</p></div></div>

    {/* Compatibility markers for the established Forge validators:
    ...
    */}
    ...
    <style jsx global>{`
      .npc-forge-modal-v2:has(.npc-forge-training-player-layout){width:min(1260px,calc(100vw - 32px))!important;max-width:1260px!important}.npc-forge-body:has(.npc-forge-training-player-layout){grid-template-columns:minmax(450px,43fr) minmax(0,57fr)!important}.npc-forge-body:has(.npc-forge-training-player-layout) .npc-forge-workspace{padding:14px 12px!important;background:linear-gradient(180deg,rgba(126,72,199,.025),transparent 26%)}.npc-forge-body:has(.npc-forge-training-player-layout) .npc-forge-preview{padding:14px 16px!important;background:radial-gradient(circle at 40% 0,rgba(126,72,199,.055),transparent 44%),#0a0d15}.npc-forge-training-player-layout{display:grid;gap:11px}.npc-forge-training-summary{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:0;border:1px solid rgba(255,255,255,.09);border-radius:9px;background:rgba(255,255,255,.018);overflow:hidden}.npc-forge-training-summary-card{display:grid;grid-template-columns:30px minmax(0,1fr) auto;gap:10px;align-items:center;min-width:0;padding:12px 14px;border-right:1px solid rgba(255,255,255,.075);background:linear-gradient(135deg,rgba(255,255,255,.02),rgba(126,72,199,.018))}.npc-forge-training-summary-card:last-child{border-right:0}.npc-forge-training-summary-card>img{width:28px;height:28px;object-fit:contain}.npc-forge-training-summary-card>span{display:grid;gap:2px;min-width:0}.npc-forge-training-summary-card strong{overflow:hidden;color:#f3efff;font-size:.68rem;white-space:nowrap;text-overflow:ellipsis}.npc-forge-training-summary-card small{overflow:hidden;color:rgba(255,255,255,.47);font-size:.53rem;white-space:nowrap;text-overflow:ellipsis}.npc-forge-training-summary-card>b{color:#fff;font-size:.72rem}.npc-forge-training-summary-card.is-required{box-shadow:inset 0 -2px rgba(243,191,99,.5)}.npc-forge-training-summary-card.is-complete>b{color:#9cece2}.npc-forge-training-picks{display:grid;gap:8px;padding:12px 14px 13px;border:1px solid rgba(255,255,255,.1);border-radius:10px;background:linear-gradient(135deg,rgba(255,255,255,.025),rgba(126,72,199,.025))}.npc-forge-training-picks-head{display:grid;gap:2px;margin-bottom:1px}.npc-forge-training-picks-head h3{margin:0;color:#fff;font-size:.82rem}.npc-forge-training-picks-head p{margin:0;color:rgba(255,255,255,.54);font-size:.59rem}.npc-forge-training-fixed-grants{display:grid;grid-template-columns:auto minmax(0,1fr);gap:9px;align-items:center;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.055)}.npc-forge-training-fixed-grants>span{color:rgba(255,255,255,.42);font-size:.5rem;font-weight:900;text-transform:uppercase}.npc-forge-training-fixed-grants>div{display:flex;flex-wrap:wrap;gap:5px}.npc-forge-training-fixed-grants button{display:flex;gap:6px;align-items:center;padding:3px 7px;border:1px solid rgba(88,214,199,.22);border-radius:999px;color:#c9fff7;background:rgba(88,214,199,.055);font-size:.56rem}.npc-forge-training-fixed-grants button small{color:rgba(201,255,247,.48);font-size:.44rem}.npc-forge-training-pick-group,.npc-forge-training-choice-section{border:0;border-radius:0;background:transparent}.npc-forge-training-pick-group{padding:2px 0}.npc-forge-training-group-head,.npc-forge-training-choice-section>summary{display:flex;align-items:center;justify-content:space-between;gap:10px}.npc-forge-training-group-head{margin-bottom:6px}.npc-forge-training-group-head>span,.npc-forge-training-choice-section>summary>span{display:flex;align-items:center;gap:7px;min-width:0}.npc-forge-training-group-head img,.npc-forge-training-choice-section>summary>span>img{width:18px;height:18px;object-fit:contain}.npc-forge-training-group-head b,.npc-forge-training-choice-section>summary b{color:#ba87ff;font-size:.58rem;text-transform:uppercase;letter-spacing:.055em}.npc-forge-training-group-head small{color:rgba(255,255,255,.48);font-size:.5rem}.npc-forge-training-skill-list{display:grid;gap:3px}.npc-forge-training-skill-list>button{display:grid;grid-template-columns:24px minmax(0,1fr) auto;gap:8px;align-items:center;min-height:32px;padding:5px 8px;border:1px solid rgba(255,255,255,.085);border-radius:6px;color:rgba(255,255,255,.78);background:rgba(3,5,10,.3);text-align:left}.npc-forge-training-skill-icon{display:grid;place-items:center;width:22px;height:22px;color:#aa72ff;font-size:.77rem}.npc-forge-training-skill-list>button>span{display:flex;align-items:baseline;gap:7px;min-width:0}.npc-forge-training-skill-list>button b{color:#fff;font-size:.63rem}.npc-forge-training-skill-list>button span small{color:rgba(255,255,255,.38);font-size:.47rem}.npc-forge-training-skill-list>button>em{display:grid;place-items:center;width:17px;height:17px;border:1px solid rgba(255,255,255,.18);border-radius:50%;color:rgba(255,255,255,.42);font-size:.52rem;font-style:normal}.npc-forge-training-skill-list>button.is-selected{border-color:rgba(168,108,255,.66);background:linear-gradient(90deg,rgba(126,72,199,.16),rgba(126,72,199,.035))}.npc-forge-training-skill-list>button.is-selected>em{border-color:#8d58ff;color:#0b0912;background:#8d58ff}.npc-forge-training-skill-list>button.is-background{border-color:rgba(88,214,199,.26)}.npc-forge-training-skill-list>button:disabled{opacity:.46}.npc-forge-training-choice-section{overflow:hidden;border-top:1px solid rgba(255,255,255,.055)}.npc-forge-training-choice-section>summary{list-style:none;cursor:pointer;padding:8px 0 6px}.npc-forge-training-choice-section>summary::-webkit-details-marker{display:none}.npc-forge-training-choice-section>summary em{padding:2px 6px;border-radius:999px;color:#d8c2fb;background:rgba(126,72,199,.1);font-size:.47rem;font-style:normal}.npc-forge-training-choice-section.is-required>summary em{color:#ffe0a0;background:rgba(243,191,99,.1)}.npc-forge-training-choice-section>summary i{display:flex;gap:3px;margin-left:3px}.npc-forge-training-choice-section>summary i img{width:14px;height:14px;opacity:.82}.npc-forge-training-choice-body{display:grid;gap:8px;padding:7px 0 4px}.npc-forge-training-choice-head{display:flex;justify-content:space-between;color:#fff;font-size:.6rem}.npc-forge-training-choice-head small{color:rgba(255,255,255,.5)}.npc-forge-training-route-note{margin:0;color:rgba(255,255,255,.5);font-size:.54rem}.npc-forge-training-option-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:5px;margin-top:6px}.npc-forge-training-option-grid button{padding:6px 8px;border:1px solid rgba(255,255,255,.09);border-radius:6px;color:rgba(255,255,255,.75);background:rgba(0,0,0,.2);font-size:.57rem;text-align:left}.npc-forge-training-option-grid button.is-selected{border-color:#a86cff;color:#fff;background:rgba(126,72,199,.18)}.npc-forge-training-empty{margin:0;color:rgba(255,255,255,.52);font-size:.59rem}.npc-forge-training-group-copy{margin:-1px 0 6px;color:rgba(255,255,255,.47);font-size:.52rem}.npc-forge-training-profession-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:5px}.npc-forge-training-profession-grid article{display:grid;gap:5px;padding:6px;border:1px solid rgba(255,255,255,.08);border-radius:7px;background:rgba(0,0,0,.16)}.npc-forge-training-profession-grid article.is-selected{border-color:rgba(88,214,199,.48);background:rgba(88,214,199,.055)}.npc-forge-training-profession-main{display:grid;grid-template-columns:24px minmax(0,1fr) auto;gap:6px;align-items:center;padding:0;border:0;color:inherit;background:transparent;text-align:left}.npc-forge-training-profession-main>img{width:22px;height:22px;object-fit:contain}.npc-forge-training-profession-main>span{display:grid;min-width:0}.npc-forge-training-profession-main b{color:#fff;font-size:.56rem}.npc-forge-training-profession-main small{overflow:hidden;color:rgba(255,255,255,.4);font-size:.43rem;white-space:nowrap;text-overflow:ellipsis}.npc-forge-training-profession-main em{display:grid;place-items:center;width:16px;height:16px;border:1px solid rgba(255,255,255,.18);border-radius:50%;color:rgba(255,255,255,.42);font-size:.48rem;font-style:normal}.npc-forge-training-profession-grid article.is-selected .npc-forge-training-profession-main em{border-color:#58d6c7;color:#07110f;background:#58d6c7}.npc-forge-training-profession-grid article label{display:grid;gap:2px}.npc-forge-training-profession-grid article label span{color:rgba(255,255,255,.42);font-size:.43rem;text-transform:uppercase}.npc-forge-training-profession-grid select{min-width:0;width:100%;padding:3px 5px;border:1px solid rgba(255,255,255,.12);border-radius:5px;color:#fff;background:#090b12;font-size:.5rem}.npc-forge-training-crafting-note{margin:6px 0 0;color:rgba(255,255,255,.4);font-size:.47rem;line-height:1.4}.npc-forge-training-help{display:flex;gap:9px;align-items:flex-start;padding:8px 10px;border-top:1px solid rgba(255,255,255,.06);color:rgba(255,255,255,.5)}.npc-forge-training-help>span{color:#aeb9df;font-size:.76rem}.npc-forge-training-help>div{display:grid;gap:1px}.npc-forge-training-help strong{color:#fff;font-size:.61rem}.npc-forge-training-help p{margin:0;color:rgba(255,255,255,.5);font-size:.5rem}.npc-forge-training-player-layout .npc-forge-source-choices{gap:7px;margin-top:0}.npc-forge-training-player-layout .npc-forge-source-choices__heading{display:none}.npc-forge-training-player-layout .npc-forge-source-choice-group{gap:7px;padding:8px 9px;border-radius:7px}.npc-forge-training-player-layout .npc-forge-source-choice-group>header strong{font-size:.66rem}.npc-forge-training-player-layout .npc-forge-source-choice-group>header small{font-size:.52rem}.npc-forge-training-player-layout .npc-forge-source-choice-field>span,.npc-forge-training-player-layout .npc-forge-source-choice-slots label>span{font-size:.54rem}.npc-forge-training-player-layout .npc-forge-source-choice-slots{grid-template-columns:repeat(auto-fit,minmax(150px,1fr))}.npc-forge-training-player-layout .npc-forge-rich-choice__grid{grid-template-columns:1fr!important}.npc-forge-training-player-layout .npc-forge-rich-choice__head{grid-template-columns:1fr!important}.npc-forge-body:has(.npc-forge-training-player-layout) .npc-forge-context-panel{overflow:auto}.npc-forge-body:has(.npc-forge-training-player-layout) .npc-forge-training-context-dossier{min-height:100%}@media(max-width:1180px){.npc-forge-modal-v2:has(.npc-forge-training-player-layout){width:calc(100vw - 24px)!important;max-width:none!important}.npc-forge-body:has(.npc-forge-training-player-layout){grid-template-columns:minmax(400px,47fr) minmax(0,53fr)!important}.npc-forge-training-summary{grid-template-columns:repeat(2,minmax(0,1fr))}.npc-forge-training-summary-card:nth-child(2){border-right:0}.npc-forge-training-summary-card:nth-child(-n+2){border-bottom:1px solid rgba(255,255,255,.075)}.npc-forge-training-profession-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}@media(max-width:900px){.npc-forge-body:has(.npc-forge-training-player-layout){grid-template-columns:1fr!important}.npc-forge-training-summary{grid-template-columns:repeat(4,minmax(0,1fr))}.npc-forge-training-summary-card{border-bottom:0!important}.npc-forge-training-summary-card:nth-child(2){border-right:1px solid rgba(255,255,255,.075)}.npc-forge-training-profession-grid{grid-template-columns:repeat(4,minmax(0,1fr))}}@media(max-width:720px){.npc-forge-training-summary,.npc-forge-training-profession-grid,.npc-forge-training-option-grid{grid-template-columns:repeat(2,minmax(0,1fr))}}
    `}</style>
  </div>;
}
