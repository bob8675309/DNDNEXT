...
export default function NpcForgeClassGuide({ selectedClass = null, level = 1, onFeatureDetail = null }) {
  ...
  return <div className={`npc-forge-context-card npc-forge-class-guide is-class-${theme}`}>
    ...
    <style jsx global>{`
      ...
      .npc-forge-class-guide__table-card{max-height:435px!important;padding:5px!important;overflow:auto!important}.npc-forge-class-guide__table-card .class-level-guide__table{width:100%!important;min-width:900px!important}.npc-forge-class-guide__table-card .class-level-guide__row{grid-template-columns:58px 52px minmax(300px,1.7fr) 72px 108px minmax(160px,.9fr)!important;gap:.28rem!important;min-height:34px!important;padding:.22rem .38rem!important}.npc-forge-class-guide__table-card .class-level-guide__row>div{padding:2px 3px!important;font-size:.57rem!important;line-height:1.26!important}.npc-forge-class-guide__table-card .class-level-guide__row.is-head{min-height:28px!important}
