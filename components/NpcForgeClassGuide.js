...
export default function NpcForgeClassGuide({ selectedClass = null, level = 1, onFeatureDetail = null }) {
  ...
  return <div className={`npc-forge-context-card npc-forge-class-guide is-class-${theme}`}>
    ...
    <style jsx global>{`
      ...
      .npc-forge-class-guide__table-card{max-height:545px!important;padding:6px!important;overflow:auto!important}.npc-forge-class-guide__table-card .class-level-guide__table{width:100%!important;min-width:900px!important}.npc-forge-class-guide__table-card .class-level-guide__row{grid-template-columns:58px 52px minmax(300px,1.7fr) 72px 108px minmax(160px,.9fr)!important;gap:.34rem!important;min-height:42px!important;padding:.31rem .46rem!important}.npc-forge-class-guide__table-card .class-level-guide__row>div{padding:3px 4px!important;font-size:.61rem!important;line-height:1.3!important}.npc-forge-class-guide__table-card .class-level-guide__row.is-head{min-height:34px!important}
      .npc-forge-class-guide__table-card .class-level-guide__features{display:flex!important;flex-wrap:wrap!important;gap:.24rem!important}.npc-forge-class-guide__table-card .class-level-guide__features button{appearance:none!important;padding:.2rem .42rem!important;border:1px solid rgba(196,163,255,.28)!important;border-radius:999px!important;color:rgba(255,255,255,.94)!important;background:rgba(126,75,202,.14)!important;font-family:inherit!important;font-size:.6rem!important;font-weight:650!important;line-height:1.2!important;text-decoration:none!important;transition:border-color 120ms ease,background 120ms ease,transform 120ms ease!important}.npc-forge-class-guide__table-card .class-level-guide__features button:hover,.npc-forge-class-guide__table-card .class-level-guide__features button:focus-visible{border-color:rgba(213,184,255,.82)!important;color:#fff!important;background:rgba(142,82,231,.3)!important;transform:translateY(-1px);outline:none!important}.npc-forge-class-guide__table-card .class-level-guide__features button.is-subclass{border-color:rgba(58,188,220,.58)!important;background:rgba(28,128,151,.2)!important}.npc-forge-class-guide__table-card .class-level-guide__slots{font-size:.56rem!important;line-height:1.35!important;white-space:normal!important}
      .npc-forge-class-guide__table-card .class-level-guide__table.has-spell-progression{min-width:1060px!important}.npc-forge-class-guide__table-card .class-level-guide__row.is-spell-progression{grid-template-columns:46px 44px minmax(300px,2.7fr) 58px 82px repeat(9,minmax(36px,.34fr))!important;gap:.22rem!important}.npc-forge-class-guide__table-card .class-level-guide__row:not(.is-spell-progression){grid-template-columns:46px 44px minmax(340px,1fr)!important;gap:.32rem!important}.npc-forge-class-guide__table-card .class-level-guide__slot-head,.npc-forge-class-guide__table-card .class-level-guide__slot-cell{text-align:center!important;font-variant-numeric:tabular-nums}.npc-forge-class-guide__table-card .class-level-guide__slot-head{color:rgba(255,255,255,.56)!important;font-size:.5rem!important}.npc-forge-class-guide__table-card .class-level-guide__slot-cell{color:rgba(255,255,255,.76)!important;font-size:.57rem!important}.npc-forge-class-guide__table-card .class-level-guide__features button{cursor:pointer}.npc-forge-class-guide__table-card .class-level-guide__features button:focus-visible{outline:1px solid rgba(var(--class-secondary),.8)!important;outline-offset:1px!important}
