 ...
 *
 * Numeric equipment authority is injected by CharacterSheetPanel. This base
 * remains responsible only for sheet editing and presentation.
 */
export default function CharacterSheetPanelBase({
  sheet,
  characterName,
  nameRight = null,
  metaLine = null,
