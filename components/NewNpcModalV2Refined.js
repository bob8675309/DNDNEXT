...
import { CharacterForgeCatalogList, CharacterForgeDiceSummary } from "./CharacterForgeControls";

const STEP_LABELS = Object.freeze(["Species", "Background", "Class", "Abilities", "Training", "Story", "Identity", "Review"]);
const CatalogList = CharacterForgeCatalogList;
const DiceSummary = CharacterForgeDiceSummary;
