...
export default function NewNpcModalV2({ show, onClose, onCreated, locations = [] }) {
  ...
  function rerollScores() {
    ...
    setRolls(rollAbilityPool()); patch({ abilityMethod: "rolled" });
  }
